...
<%
Collection<?> products = (Collection<?>) request.getAttribute("prova1");
...
<link rel="stylesheet"
	href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/f">
			...
			<div class="col-sm">
				<div class="card mt-3"
					...
					<div class="product-1 align-items-center p-2 text-center">
						...
						<form action="Moto" method="post" name="myForm" onsubmit="return validateForm()">
