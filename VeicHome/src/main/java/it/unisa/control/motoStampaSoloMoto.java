...
@WebServlet("/motoStampaSoloMoto")
public class motoStampaSoloMoto extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public motoStampaSoloMoto() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			request.setAttribute("prova1", model.cercaMoto(""));
		...
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/testingStampaSoloMoto.jsp");
