...
<%
		...
		ProductAuto cl1 = new ProductAuto();
%>
...
<form action="<%=response.encodeURL("InserimentoAuto")%>" method="POST" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()">
			<fieldset>
				<legend><b>Insrimento auto</b></legend>
				...
				<br><label for="sconto">Sconto:</label>
				<input type="text" name="sconto" value="<%=cl1.getSconto() %>">
				
				<br><label for="numero_di_passegeri">Numero di passegeri:</label>
				<input type="text" name="numero_di_passegeri" value="<%=cl1.getNumero_di_passgeri() %>">
